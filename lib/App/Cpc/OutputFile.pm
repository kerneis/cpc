...
stage of a C<Cpc>-based compiler.  This is an abstract base class
...
C<Cpc> often creates command vectors with a mix of strings and
...
Common utility methods like C<Cpc::runShell> already do exactly this
...
C<Cpc> uses this method to register input files that it discovers
